...
const FALLBACK = {
  ...
  cta1: 'Watch Founder Interviews', cta1_url: '/interviews-success-stories',
  cta2: 'Read Success Stories', cta2_url: '/resource-centre/blogs',
...
export default function InsightsHero() {
  ...
  const cta1 = section?.cta_text ?? FALLBACK.cta1;
  const cta1Url = section?.cta_url ?? FALLBACK.cta1_url;
  const cta2 = section?.cta_text_2 ?? FALLBACK.cta2;
  const cta2Url = section?.cta_url_2 ?? FALLBACK.cta2_url;
  const searchPlaceholder = c.search_placeholder ?? FALLBACK.search_placeholder;
  const bgImage = section?.media_url ?? FALLBACK_BG;
